            ...
            <div className="relative flex flex-col items-center gap-12">
                ...
                >
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <button
                            onClick={() => window.open("https://cal.com/solanki-vedant-qhzoml", "_blank")}
                            className="relative mt-4 flex size-16 items-center justify-center sm:size-20 cursor-pointer"
                        >
                            <div
                ...
                >
                    ...
                    <span className="text-xs tracking-widest uppercase text-muted-foreground/60">vedants1968@gmail.com</span>
                </div>
            </div>
        </section>
    )
